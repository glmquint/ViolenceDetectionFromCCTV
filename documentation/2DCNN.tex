...
\begin{table}[]
    ...
    \multicolumn{1}{|c|}{\textbf{Final model}} & 0,62619            & 0,49048                   & 0,7619                          \\ \hline
    \end{tabular}%
    }
